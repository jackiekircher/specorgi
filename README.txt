Thank you for downloading Specorgi! This is a mod for Spelunky HD by Mossmouth Games
which replaces the pug damsel with a corgi. I've tried to stay as true to the original
art style as I could.
...
** Make sure to backup the alltex.wad and alltex.wad.wix files in the /Data/Textures
   directory of your Spelunky installation path. **

1. Replace these files with the alltex.wad and alltext.wad.wix files for the mod.
...
4) Repack the alltex folder with `spelunktool -c alltex` or dragging it onto the repack.bat
   file.
